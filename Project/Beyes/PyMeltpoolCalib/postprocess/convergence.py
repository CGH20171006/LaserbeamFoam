...
def save_convergence_plot(
    ...
    # 左图：所有评估
    ax1.semilogy(iterations, costs_array, "o-", alpha=0.5, markersize=3, label="SSE")
    ...
    ax2.set_ylabel("Best SSE (log scale)")
    ax2.set_title("Best SSE Evolution")
...
def plot_multi_direction_comparison(
    ...
    ax1.set_ylabel("Final SSE")
    ax1.set_title("Final SSE by Direction")
    ax1.set_yscale("log")
