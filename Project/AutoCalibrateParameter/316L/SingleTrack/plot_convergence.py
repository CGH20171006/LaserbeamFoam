...
# 自动定位 applications/scripts 目录
SCRIPT_DIR = Path(__file__).parent
REPO_ROOT = SCRIPT_DIR / "../../../.."  # -> LaserbeamFoam
SCRIPTS_DIR = REPO_ROOT / "applications" / "scripts"
sys.path.insert(0, str(SCRIPTS_DIR.resolve()))

from AutoCalibrateParameter.postprocess.convergence import save_convergence_plot, plot_parameter_evolution
